...
function BookingCar() {
  ...
  useEffect(() => {
    setTotalAmount(totalMins * Math.ceil(car.rentPerHour / 180));
    if (driver) {
              ...
              {from && to && (
                ...
                >
                  ...
                  <StripeCheckout
                    ...
                    stripeKey="pk_test_51NttXQSFuOjSm3Z2gygdAFeCqxUcCLC8neRivXjMyMXBOZnglJcvNhPeBrjDtBtmcF8HWXwqgjc7MvENYbvXDmuT00pG3EyWL4"
                  >
                    <button
                      className="btn1"
                      style={{
